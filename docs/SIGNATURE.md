...
- **Certum Open Source dans le cloud** : offre destinée aux développeurs individuels, affichée à partir de 49 EUR, mais indiquée **indisponible** lors de la vérification. Ne pas la présenter comme une solution achetable immédiatement, ni déduire une durée ou un prix total du tarif d’appel. SimplySign mobile et Desktop sont requis ; la compatibilité de notre CI n’a pas été validée. [Fiche produit](https://shop.certum.eu/open-source-code-signing-on-simplysign.html).
