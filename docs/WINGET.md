...
3. Exécuter `scripts/winget.ps1 -Version 0.8.0`. Le script vérifie le SHA-256 de l’installateur, produit les trois fichiers sous `artifacts/winget/manifests/a/Aleqsd/CodexTracker/0.8.0`, puis appelle `winget validate`.
