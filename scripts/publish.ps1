...
foreach ($document in @('dashboard.png', 'dashboard-light.png', 'advice.png', 'history.png', 'VALIDATION.md', 'tray-minimal.png', 'personalization.png', 'calendar.png', 'settings.png', 'resets.png', 'reminders.png', 'channels.png', 'installer.png', 'assistants.png', 'MCP.md', 'ARCHITECTURE.md', 'DESIGN.md', 'PRIVACY.md', 'WINGET.md', 'resets-week.png', 'updates.png', 'tour.gif', 'UTILISATION.md')) {
